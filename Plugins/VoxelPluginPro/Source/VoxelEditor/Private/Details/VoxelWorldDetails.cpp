...
inline UStaticMesh* BakeProcMesh(UVoxelProceduralMeshComponent* ProcMeshComp, const FString& PackageName, UStaticMesh* StaticMeshTemplate, bool bRecomputeNormals)
{
	...
	auto* StaticMesh = FVoxelCreateStaticMeshFromProcMesh::Create(ProcMeshComp, [&]()
	{
		...
		return NewObject<UStaticMesh>(Package, MeshName, RF_Public | RF_Standalone, StaticMeshTemplate);
